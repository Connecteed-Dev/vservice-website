...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: isIT
      ? `V.Service è leader nella climatizzazione e riscaldamento a Roma e nel Lazio. Progettazione, installazione e manutenzione di impianti termici civili e industriali con oltre ${yearsActive()} anni di esperienza.`
